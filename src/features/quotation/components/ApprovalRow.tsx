      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <Text style={[styles.requestId, { color: colors.text }]}>
            {approval.quotationOfferNo || `#${approval.approvalRequestId}`}
          </Text>
        ...
        {(approval.quotationCustomerName || approval.approvalRequestDescription) && (
        ...
        <View style={styles.details}>
          ...
          {approval.quotationRevisionNo ? (
            <View style={styles.detailRow}>
              <Text style={[styles.detailLabel, { color: colors.textMuted }]}>Revize:</Text>
              <Text style={[styles.detailValue, { color: colors.text }]}>{approval.quotationRevisionNo}</Text>
            </View>
          ) : null}

          {approval.quotationGrandTotalDisplay ? (
            <View style={styles.detailRow}>
              <Text style={[styles.detailLabel, { color: colors.textMuted }]}>Toplam:</Text>
              <Text style={[styles.detailValue, { color: colors.text }]}>{approval.quotationGrandTotalDisplay}</Text>
            </View>
          ) : null}
