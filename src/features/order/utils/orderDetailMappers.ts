...
function mapDetailLineToFormState(d: OrderLineDetailGetDto): OrderLineFormState {
  const base: OrderLineFormState = {
    ...
    description3: d.description3 ?? null,
    profilDefinitionId: d.profilDefinitionId ?? null,
    demirDefinitionId: d.demirDefinitionId ?? null,
    vidaDefinitionId: d.vidaDefinitionId ?? null,
    vidaDefinitionName: d.vidaDefinitionName ?? null,
    baskiDefinitionId: d.baskiDefinitionId ?? null,
    baskiDefinitionName: d.baskiDefinitionName ?? null,
    baskiAciklama: d.baskiAciklama ?? null,
