      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <Text style={[styles.requestId, { color: colors.text }]}>
            {approval.demandOfferNo || `#${approval.approvalRequestId}`}
          </Text>
        ...
        {(approval.demandCustomerName || approval.approvalRequestDescription) && (
        ...
        <View style={styles.details}>
          ...
          {approval.demandRevisionNo ? (
            <View style={styles.detailRow}>
              <Text style={[styles.detailLabel, { color: colors.textMuted }]}>Revize:</Text>
              <Text style={[styles.detailValue, { color: colors.text }]}>{approval.demandRevisionNo}</Text>
            </View>
          ) : null}

          {approval.demandGrandTotalDisplay ? (
            <View style={styles.detailRow}>
              <Text style={[styles.detailLabel, { color: colors.textMuted }]}>Toplam:</Text>
              <Text style={[styles.detailValue, { color: colors.text }]}>{approval.demandGrandTotalDisplay}</Text>
            </View>
          ) : null}
