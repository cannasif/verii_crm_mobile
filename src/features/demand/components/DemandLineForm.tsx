...
export function DemandLineForm({
  ...
  const hideVatRate = Boolean(effectiveSystemSettings.hideDemandVatRate);
  const readonlyVatRate = Boolean(effectiveSystemSettings.readonlyDemandVatRate);
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          >
            ...
            >
              <Text style={[styles.summaryTitle, { color: textColor }]}>{t("demand.calculationSummary")}</Text>
              <View style={styles.summaryRow}>
                <Text style={[styles.summaryLabel, { color: mutedColor }]}>{t("demand.subtotal")}</Text>
              ...
              <View style={styles.summaryRow}>
                <View style={styles.summaryLabelWithMeta}>
                  <Text style={[styles.summaryLabel, { color: mutedColor }]}>{t("demand.vat")}</Text>
            ...
            >
              ...
              <View style={[styles.summaryRow, styles.summaryRowTotal, { borderTopColor: borderColor }]}>
                <Text style={[styles.summaryLabel, { color: textColor, fontWeight: "700" }]}>Genel Toplam:</Text>
                <Text style={[styles.summaryValue, { color: brandColor, fontWeight: "800" }]}>
                  {currentLine.lineGrandTotal.toFixed(2)}
                </Text>
              </View>
            ...
            {displayedRelatedLines.length > 0 && (
              <View style={[styles.relatedSummaryCard, { backgroundColor: cardBg, borderColor }]}>
                <Text style={[styles.relatedSummaryTitle, { color: textColor }]}>{t("demand.relatedStocksSummary")}</Text>
                {displayedRelatedLines.map((rel) => (
                  <View key={rel.id} style={[styles.relatedSummaryRow, { borderBottomColor: borderColor }]}>
                    ...
                    <View style={styles.relatedSummaryGrid}>
                      <Text style={[styles.relatedSummaryLabel, { color: mutedColor }]}>{t("demand.discount1")}:</Text>
                      <Text style={[styles.relatedSummaryValue, { color: textColor }]}>% {rel.discountRate1.toFixed(1)}</Text>
                      <Text style={[styles.relatedSummaryLabel, { color: mutedColor }]}>{t("demand.discountAmount1")}:</Text>
                      <Text style={[styles.relatedSummaryValue, { color: textColor }]}>{rel.discountAmount1.toFixed(2)}</Text>
                      <Text style={[styles.relatedSummaryLabel, { color: mutedColor }]}>{t("demand.discount2")}:</Text>
                      <Text style={[styles.relatedSummaryValue, { color: textColor }]}>% {rel.discountRate2.toFixed(1)}</Text>
                      <Text style={[styles.relatedSummaryLabel, { color: mutedColor }]}>{t("demand.discountAmount2")}:</Text>
                      <Text style={[styles.relatedSummaryValue, { color: textColor }]}>{rel.discountAmount2.toFixed(2)}</Text>
                      <Text style={[styles.relatedSummaryLabel, { color: mutedColor }]}>{t("demand.discount3")}:</Text>
                      <Text style={[styles.relatedSummaryValue, { color: textColor }]}>% {rel.discountRate3.toFixed(1)}</Text>
                      <Text style={[styles.relatedSummaryLabel, { color: mutedColor }]}>{t("demand.discountAmount3")}:</Text>
