                          ...
                          >
                            ...
                            <View style={[styles.linePairRow, { borderBottomColor: innerBorder }]}>
                              <View style={styles.lineHalf}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.quantity")}</Text>
                              ...
                              <View style={[styles.lineHalf, styles.lineHalfTrailing]}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.unitPrice")}</Text>
                                <Text style={[styles.lineMicroValue, { color: accent }]} numberOfLines={1}>
                            ...
                            <View style={[styles.linePairRow, { borderBottomColor: innerBorder }]}>
                              <View style={styles.lineHalf}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.discount1")}</Text>
                              ...
                              <View style={[styles.lineHalf, styles.lineHalfTrailing]}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.discount2")}</Text>
                                <Text style={[styles.lineMicroValue, { color: colors.textSecondary }]} numberOfLines={2}>
                            ...
                            <View style={[styles.linePairRow, { borderBottomColor: innerBorder }]}>
                              <View style={styles.lineHalf}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.discount3")}</Text>
                                <Text style={[styles.lineMicroValue, { color: colors.textSecondary }]} numberOfLines={2}>
                              ...
                              <View style={[styles.lineHalf, styles.lineHalfTrailing]}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.lineTotal")}</Text>
                                <Text style={[styles.lineMicroValue, { color: accent }]} numberOfLines={1}>
                            ...
                            <View style={[styles.linePairRow, styles.linePairRowLast, { borderBottomColor: innerBorder }]}>
                              <View style={styles.lineHalf}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.vatRate")}</Text>
                              ...
                              <View style={[styles.lineHalf, styles.lineHalfTrailing]}>
                                <Text style={[styles.lineMicroLabel, { color: mutedText }]} numberOfLines={1}>{t("demand.vatAmount")}</Text>
                                <Text style={[styles.lineMicroValue, { color: titleText }]} numberOfLines={1}>
