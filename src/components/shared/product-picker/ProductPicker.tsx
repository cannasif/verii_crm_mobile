...
import {
  STOCK_PICKER_AVAILABLE_SEARCH_FIELDS,
  STOCK_PICKER_SEARCH_FIELD_LABELS,
  STOCK_PICKER_SEARCH_FIELDS,
} from "@/lib/pagedSearchFields";
...
import type { StockGetDto, StockRelationDto } from "@/features/stocks/types/stock";
import {
...
export interface ProductPickerVoiceSearchButtonProps {
  onResult: (text: string) => void;
  disabled?: boolean;
  embedded?: boolean;
}

interface SharedProductPickerProps extends ProductPickerProps {
  pricingRuleType: "Order" | "Quotation" | "Demand";
  VoiceSearchButtonComponent: React.ComponentType<ProductPickerVoiceSearchButtonProps>;
}
...
function ProductPickerInner(
  {
    ...
    queuedProductKeys = [],
    pricingRuleType,
    VoiceSearchButtonComponent,
  }: SharedProductPickerProps,
                ...
                >
                  <View style={styles.searchTopRow}>
                    ...
                    >
                      ...
                      <VoiceSearchButtonComponent onResult={setSearchText} embedded />
...
export const ProductPicker = forwardRef<ProductPickerRef, SharedProductPickerProps>(
  ProductPickerInner
);
